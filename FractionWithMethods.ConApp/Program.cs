...
namespace FractionWithMethods.ConApp
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            // Eingabe (E)
            Console.WriteLine("***************************************");
            Console.WriteLine("* Fraction with methods               *");
            Console.WriteLine("***************************************");
            ...
            s = Fraction.Addition(a, 3);
            f = Fraction.Addition(b, d);
            g = Fraction.Addition(c, e);
            h = Fraction.Addition(f, g);
            Console.WriteLine();
            ...
            i = Fraction.Subtraction(b, d);
            j = Fraction.Subtraction(c, e);
            k = Fraction.Subtraction(f, g);
            Console.WriteLine();
            ...
            l = Fraction.Division(b, d);
            m = Fraction.Division(c, e);
            n = Fraction.Division(f, g);
            Console.WriteLine();
            ...
            o = Fraction.Multiplication(b, d);
            p = Fraction.Multiplication(c, e);
            q = Fraction.Multiplication(f, g);
            Console.WriteLine();
